				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane" id="camera">
						<p>
							...
							<a href='javascript:void(0)' class='aos' data-esp='cam' data-cmd='move_forward9.9'><i class="fa fa-arrow-up fa-2x" aria-hidden="true"></i></a>
							<a href='javascript:void(0)' class='aos' data-esp='cam' data-cmd='move_backward9.9'><i class="fa fa-arrow-down fa-2x" aria-hidden="true"></i></a>
						</p>
