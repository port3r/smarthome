			...
			<div class='col-md-12'>  
				...
				<div class="tab-content">
					...
					<div role="tabpanel" class="tab-pane" id="zahrada">
						<ul class='list-group'>
							<li class='list-group-item'>Ovládanie brány <span class='pull-right iost'><a href='javascript:void(0)' class='aos' data-esp='' data-cmd=''><i class="fa fa-exchange fa-2x" aria-hidden="true"></i></a></span></li>
